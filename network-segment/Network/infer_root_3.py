...
def main():
    ...
    with torch.no_grad():
        ...
        for img_file in tbar:
            ...
            makedir(result_path)
            vis_images = [rgb_img, prediction, pred_prob[..., 3] > 2e-1, pred_prob[..., 3]>7e-1]
            vis_palettes = ['RGB', 'label', 'label', 'label']
            texts = ['RGB', 'ArgMax', 'cls_3_0.2', 'cls_3_0.7']
...
def parse_arguments():
    ...
    parser.add_argument('-o', '--output', default='outputs', type=str,
                        help='Output Path')
    parser.add_argument('-e', '--extension', default='_zm.jpg', type=str,
